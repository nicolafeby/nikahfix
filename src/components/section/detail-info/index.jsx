...
export default function DetailInfo() {
  ...
  return (
    <div className="space-y-5 pb-10">
      <div className="w-full relative overflow-hidden" style={{ height: '40vh' }}>
        <div>
          <video
            ref={videoRef}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-2 bg-gradient-to-t from-black via-black/70 to-transparent text-white">
            <h1 className="text-xl font-bold mb-2">Nicola &amp; Anita:<br /> Hari Pernikahan Kita</h1>
            <p className="text-base">A story that intertwines love, challenges, and destiny in one journey.</p>
          </div>
